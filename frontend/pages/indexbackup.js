  ...
  return (
    <div className="container">
      ...
      <header>
        ...
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a system name"/>
        </div>
...
export async function getServerSideProps(context) {
  try {
    ...
    const data = await db.collection("systeminfo").find({}).limit({}).toArray();
...
function myFunction() {
    ...
    card = grid.getElementsById("mycard");
